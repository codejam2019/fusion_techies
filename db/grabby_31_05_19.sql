...
CREATE TABLE `user_blocked_tag` (
  ...
  KEY `tag_id` (`tag_id`),
  CONSTRAINT `user_blocked_tag_ibfk_1` FOREIGN KEY (`tag_id`) REFERENCES `tag` (`id`),
...
CREATE TABLE `user_preferred_tag` (
  ...
  PRIMARY KEY (`user_id`,`tag_id`),
  KEY `tag_id` (`tag_id`),
  CONSTRAINT `user_preferred_tag_ibfk_1` FOREIGN KEY (`tag_id`) REFERENCES `tag` (`id`),
...
-- Dump completed on 2019-05-31  8:47:46
